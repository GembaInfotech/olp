...
const uploadImg = require("../middlewares/ImageUpload/cloudinary");
...
const addUser = async (req, res, next) => {
  const {name, email, password, isConsentGiven, role } =req.body;
  console.log(name)
  ...
  const fileUrl = req.imagepath ? req.imagepath : defaultAvatar;
